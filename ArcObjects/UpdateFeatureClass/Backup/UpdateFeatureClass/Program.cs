...
//            if (arcInit.InitializeArcObjects().GetType() != typeof(Exception))
            ...
            {
                login = loginObj.openSDEWorkspace("th-gis", "sde:sqlserver:th-gis", "SDEeditors", "SDEeditors", "VECTOR", "sde.DEFAULT", "OSA");
    ...
    class FeatureOperations
    {
        ...
        private void GetDataSet()
        {
            ...
            while (ds != null)
            {
                if (ds.Name == "VECTOR.SDEADMIN.CADASTRAL")
                {
                    ...
                    while (sdeclass != null)
                    {
                        if (sdeclass.Name == "VECTOR.SDEADMIN.Tax_Parcels_1")
                        {
        ...
        private void CopyFeatureClass(IDataset ds,IWorkspace sourceWorkspace)
        {
            ...
            sourceDatasetName.Name = "VECTOR.SDEADMIN.Tax_Parcels_1";
        ...
        private void UpdateFeatures(IDataset dataset, ArrayList list)
        {
            ...
            foreach (object[] record in list)
            {
                ...
                string taxmap   = record[1].ToString();
                ...
                int taxmap_id   = fields.FindField("TAXMAP");
                int tmapumft_id = fields.FindField("GV_TAXMAP");
                ...
                while (feature != null)
                {
                    ...
                    feature.set_Value(taxmap_id, taxmap);
