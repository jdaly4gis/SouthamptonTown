...
function subjectPropertyInfo(item, buildings, picInfo, changeBuildingString, infoclass, buildingValue) {
    ...
    var subInfo = "<div id='" + item.i.P_ID + "' class='" + infoclass + "'>" + picInfo +
                    ...
                    "<li><span class='arLbl'><strong>Misc Value (Pools, sheds, TC, etc.):</strong></span><span class='arVal'>" + currency(item.i.MISC_VALUE) + "</span></li>" +
...
function changeBuilding(obj, classs) {
    var id = obj.value;
    if (!id) {
