...
esri.layers.ArcGISDynamicMapServiceLayer = function (url,options) {
    ...
    /// <param name="url" type="String" optional="false">URL to the ArcGIS Server REST resource that represents a map service. An example is https://sampleserver1.arcgisonline.com/ArcGIS/rest/services/Demographics/ESRI_Population_World/MapServer. For more information on constructing a URL, see The Services Directory and the REST API.</param>
    /// <param name="options" type="Object" optional="true">Optional parameters. See options list.&#10;
    /// &#60;String&#62; className&#10;
    /// &#60;String&#62; gdbVersion&#10;
    /// &#60;String&#62; id&#10;
...
esri.layers.ArcGISImageServiceLayer = function (url,options) {
    ...
    /// <param name="url" type="String" optional="false">URL to the ArcGIS Server REST resource that represents a map service. An example is https://sampleserver1.arcgisonline.com/ArcGIS/rest/services/Portland/Portland_ESRI_LandBase_AGO/MapServer. For more information on constructing a URL, see The Services Directory and the REST API.</param>
    /// <param name="options" type="Object" optional="true">Optional parameters. See options list.&#10;
    /// &#60;String&#62; id&#10;
...
esri.layers.FeatureLayer = function (url,options) {
    ...
    /// <param name="url" type="String" optional="false">URL to the ArcGIS Server REST resource that represents a feature service. An example is https://sampleserver1.arcgisonline.com/ArcGIS/rest/services/Demographics/ESRI_Population_World/MapServer/0. For more information on constructing a URL, see The Services Directory and the REST API.</param>
    /// <param name="options" type="Object" optional="true">Optional parameters. See options list.&#10;
...
esri.layers.LabelLayer.prototype = 
{
    addFeatureLayer: function (featureLayer,renderer,textExpression,labelOptions) {
        ...
        /// <param name="featureLayer" type="FeatureLayer" optional="false">The feature layer to be added to the label layer. Use FeatureLayer.MODE_ONDEMAND to improve the performance. Be sure the field(s) you would like to display is included in outFields.var featureLayer = new FeatureLayer( "https://sampleserver6.arcgisonline.com/arcgis/rest/services/WorldTimeZones/MapServer/0", { mode: FeatureLayer.MODE_ONDEMAND, outFields: ["CITY_NAME"] });</param>
...
esri.layers.WMSLayer = function (url,options) {
    ...
    /// <param name="url" type="String" optional="false">URL to the OGC Web Map Service. An example is https://sampleserver1.arcgisonline.com/ArcGIS/services/Specialty/ESRI_StatesCitiesRivers_USA/MapServer/WMSServer.</param>
    /// <param name="options" type="Object" optional="true">Optional parameters. See options list.&#10;
    /// &#60;String&#62; format&#10;
    /// &#60;Object&#62; resourceInfo&#10;
    /// &#60;Boolean&#62; transparent&#10;
...
esri.layers.WebTiledLayer = function (urlTemplate,options) {
    ...
    /// <param name="urlTemplate" type="String" optional="false">The url template to retrieve the tiles. The url template follows a pattern of https://some.domain.com/${Z}/${X}/${Y}/ where Z corresponds to a zoom level, and X and Y represent tile column and row, respectively.</param>
...
esri.tasks.FindTask = function (url,options) {
    ...
    /// <param name="url" type="String" optional="false">URL to the ArcGIS Server REST resource that represents a layer in a service. An example is https://sampleserver1.arcgisonline.com/ArcGIS/rest/services/Portland/Portland_ESRI_LandBase_AGO/MapServer/1. For more information on constructing a URL, see The Services Directory and the REST API.</param>
    /// <param name="options" type="Object" optional="true">Optional parameters. See options list.&#10;
...
esri.tasks.GeometryService = function (url) {
    ...
    /// <param name="url" type="String" optional="false">Set the url to the ArcGIS Server REST resource that represents a GeometryService, e.g. https://sampleserver3.arcgisonline.com/ArcGIS/rest/services/Geometry/GeometryServer.For more information on constructing a URL, see the ArcGIS Services Directory.</param>
...
esri.tasks.Geoprocessor = function (url) {
    ...
    /// <param name="url" type="String" optional="false">URL to the ArcGIS Server REST resource that represents a geoprocessing service. An example is https://sampleserver1.arcgisonline.com/ArcGIS/rest/services/Network. For more information on constructing a URL, see The Services Directory and the REST API.</param>
    /// <field name="outSpatialReference" type="SpatialReference">The spatial reference of the output geometries.</field>
...
esri.tasks.ImageServiceIdentifyTask = function (url) {
    ...
    /// <param name="url" type="String" optional="false">URL to the ArcGIS Server REST resource that represents an image service.require([ "esri/tasks/ImageServiceIdentifyTask", ... ], function(ImageServiceIdentifyTask, ... ) { var imageTask = new ImageServiceIdentifyTask("https://servicesbeta.esri.com/ArcGIS/rest/services/Portland/PortlandAerial/ImageServer"); ...});</param>
};
...
esri.tasks.Locator = function (url) {
    ...
    /// <param name="url" type="String" optional="false">URL to the ArcGIS Server REST resource that represents a locator service. An example is https://sampleserver1.arcgisonline.com/ArcGIS/rest/services/Locators/ESRI_Geocode_USA/GeocodeServer. For more information on constructing a URL, see The Services Directory and the REST API.</param>
    /// <field name="outSpatialReference" type="SpatialReference">The spatial reference of the output geometries.</field>
    /// <field name="url" type="String">URL to the ArcGIS Server REST resource that represents a locator service.</field>
};
...
esri.virtualearth.VEGeocoder.prototype = 
{
    ...
    setCulture: function (culture) {
        ...
        /// <param name="culture" type="String" optional="false">The culture value. The default value is "en-US". For a list of supported cultures, see https://msdn.microsoft.com/en-us/library/cc981048.aspx.</param>
    },
};
