var DragHandler = {
    ...
    attach: function (oElem) {
        //oElem.children.test.parentElement.onMousedown
    ...
    _dragBegin: function (e) {
        ...
        if (isNaN(parseInt(oElem.parentElement.style.left))) {
            oElem.parentElement.style.left = '0px';
        }
        if (isNaN(parseInt(oElem.parentElement.style.top))) {
            oElem.parentElement.style.top = '0px';
        }
